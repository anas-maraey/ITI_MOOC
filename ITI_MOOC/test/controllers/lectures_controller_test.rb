...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post :create, lecture: { content: @lecture.content, course_id: @lecture.course_id, title: @lecture.title, user_id: @lecture.user_id }
    end
  ...
  test "should update lecture" do
    patch :update, id: @lecture, lecture: { content: @lecture.content, course_id: @lecture.course_id, title: @lecture.title, user_id: @lecture.user_id }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
